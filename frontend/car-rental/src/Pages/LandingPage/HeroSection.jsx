  ...
  return (
    ...
    <div className='absolute z-20 top-0 left-0 h-full w-full sm:p-4 p-2'>
      <div className='flex items-center justify-between'>
        ...
        <button className="bg-custom-grey sm:text-base text-xs  py-1 px-1.5 sm:py-2  cursor-pointer sm:px-5 rounded-3xl text-white font-bold transition-transform transform hover:scale-105 hover:shadow-lg">
                Log In/Sign Up
        </button>               
      </div>
      <div className='flex flex-col justify-evenly'>
        ...
        <button className='bg-custom-dark py-3 px-6 rounded-3xl w-fit mt-4 text-white font-bold transition-transform transform hover:scale-105 hover:shadow-lg cursor-pointer'>
            Get Started!
        </button>
      </div>
    </div> 
